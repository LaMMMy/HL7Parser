...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n1="urn:hl7-org:v2xml">
  ...
  ***NOTE:
  ...
  <xsl:template match="n1:*">
    ...
    <xsl:apply-templates select="//IN2"/>
  ...
  <xsl:template match="//IN1">
    <div class="bs-example IN1" id="IN1">
      <dl class="dl-horizontal">
        <dt>Insurance Plan ID</dt>
        <dd id="IN1.2">
          <xsl:value-of select="IN1.2/*"/>
        </dd>
        <dt>Insurance Company ID</dt>
        <dd id="IN1.3">
          <xsl:value-of select="IN1.3/*"/>
        </dd>
        <dt>Insurance Company Name</dt>
        <dd id="IN1.4">
          <xsl:value-of select="IN1.4/*"/>
        </dd>
        <xsl:if test="IN1.5/*">
          <dt>Insurance Co. Address</dt>
          <dd id="IN1.5">
            <xsl:call-template name="formatAddress">
              <xsl:with-param name="addr" select="IN1.5/*"/>
            </xsl:call-template>
          </dd>
        </xsl:if>
        <xsl:if test="IN1.10/*">
          <dt>Insurance Group Emp ID</dt>
          <dd id="IN1.10">
            <xsl:value-of select="IN1.10/*"/>
          </dd>
        </xsl:if>
        <xsl:if test="IN1.11/XON.1/*">
          <dt>Insurance Group Emp Name</dt>
          <dd id="IN1.11/XON.1/*">
            <xsl:value-of select="IN1.11/XON.1/*" />            
          </dd>
        </xsl:if>
        <xsl:if test="IN1.12/*">
          ...
          <dd id="IN1.12">
            <xsl:call-template name="formatDateTime">
              <xsl:with-param name="date" select="IN1.12/*"/>
            </xsl:call-template>
          </dd>
        </xsl:if>
        <xsl:if test="IN1.13/*">
          ...
          <dd id="IN1.13">
            <xsl:call-template name="formatDateTime">
              <xsl:with-param name="date" select="IN1.13/*"/>
            </xsl:call-template>
          </dd>
        </xsl:if>
        ...
        <dd id="IN1.18">
          <xsl:call-template name="formatDateTime">
            <xsl:with-param name="date" select="IN1.18/*"/>
          </xsl:call-template>
        </dd>
        <dt>Insured&apos;s Address</dt>
        <dd id="PID.19">
          <xsl:call-template name="formatAddress">
            <xsl:with-param name="addr" select="IN1.19/*"/>
          </xsl:call-template>
        </dd>
        <dt>Policy Number</dt>
        <dd id="IN1.36">
          <xsl:value-of select="IN1.36/*"/>
        </dd>
        <dt>Insured&apos;s Employment Status</dt>
        <dd id="IN1.IN1.42">
          <xsl:value-of select="IN1.IN1.42/*"/>
        </dd>
        <dt>Insured&apos;s Administrative Sex</dt>
        <dd id="IN1.43">
          <xsl:value-of select="IN1.43/*"/>
        </dd>
        <dt>Insured&apos;s Employer&apos;s Address</dt>
        <dd id="IN1.44">
          <xsl:call-template name="formatAddress">
            <xsl:with-param name="addr" select="IN1.44/*"/>
          </xsl:call-template>
        </dd>
        <dt>Insured&apos;s ID Number</dt>
        <dd id="IN1.IN1.49">
          <xsl:value-of select="IN1.IN1.49/*"/>
        </dd>
      </dl>
    </div>
  </xsl:template>
  ...
  <xsl:template match="//IN2">
    <div class="bs-example IN2" id="IN2">
      <dl class="dl-horizontal">
        <dt>Insured&apos;s Employer&apos;s Name and ID</dt>
        <dd id="IN2.3">
          <xsl:value-of select="IN2.3/*"/>
        </dd>
        <dt>Employer Information Data</dt>
        <dd id="IN2.4">
          <xsl:value-of select="IN2.4/*"/>
        </dd>
        <dt>Medicaid Case Name</dt>
        <dd id="IN2.7">
          <xsl:value-of select="IN2.7/*"/>
        </dd>
        <dt>Medicaid Case Number</dt>
        <dd id="IN2.8">
          <xsl:value-of select="IN2.8/*"/>
        </dd>
        <dt>Insured&apos;s Phone Number</dt>
        <dd id="IN2.63">
          <xsl:value-of select="normalize-space(IN2.63)"/>
        </dd>
        <dt>Insured&apos;s Employer Phone Number</dt>
        <dd id="IN2.64">
          <xsl:value-of select="normalize-space(IN2.64)"/>
        </dd>
      </dl>
    </div>
  </xsl:template>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <xsl:if test="normalize-space($docField[name() = 'XCN.8'])">
          <xsl:text>Custom ID:</xsl:text>
          <xsl:value-of select="normalize-space($docField[name() = 'XCN.8'])"/>
        </xsl:if>
